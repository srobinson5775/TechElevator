...
public class ExercisesTest {
	...
	public void exercise07_foundIntTwice() {
		assertEquals("Input: foundIntTwice(new ArrayList<Integer>(Arrays.asList(55, 17, 3, 6, 12)), 4)", false,
				exercises.foundIntTwice(new ArrayList<Integer>(Arrays.asList(55, 17, 3, 6, 12)), 4));
		...
		assertEquals("Input: foundIntTwice(new ArrayList<Integer>(Arrays.asList(9, 9, 44, 2, 88, 9)), 9)", true,
				exercises.foundIntTwice(new ArrayList<Integer>(Arrays.asList(9, 9, 44, 2, 88, 9)), 9));
	}
