...
public class Adoption {
    ...
    public String adoptRescueDog(String owner, Dog rescueDog){
        ...
        String adoptionMessage = "Congratulations " + rescueDog.getOwner() + "! you are the proud owner of " + rescueDog.getName() + " .... a lovable " +rescueDog.getAge() + "year old " + rescueDog.getBreed();
